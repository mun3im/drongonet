...
def build_cnn_mel_model_table2(
    ...
    # Global Average Pooling + small projection
    ...
    model = tf.keras.models.Model(inputs, outputs, name=f"XiaoChirp_Tiny_GAP_Depthwise_m{input_shape[1]}")
