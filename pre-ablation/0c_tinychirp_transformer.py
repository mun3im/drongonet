...
class TrainingConfig:
    ...
    output_dir: str = 'results_0c_tinychirp_transformer'
    cache_dir: str = f'{CACHE_BASE}_tinychirp_waveforms'

def parse_args():
    """Parse command line arguments"""
    parser = argparse.ArgumentParser(description='Train TinyChirp Transformer-Time model')
...
def build_transformer_time_model(
    ...
    model = tf.keras.models.Model(inputs, outputs, name="TinyChirp_TransformerTime")
...
def main():
    ...
    config.output_dir = f'{RESULTS_BASE}/0c_tinychirp_transformer_r{config.random_seed}_{platform.system().lower()}'
    ...
    logger.info("="*60)
    logger.info("TinyChirp Transformer-Time Training")
    logger.info("="*60)
    ...
    try:
        ...
        with open(summary_path, 'w') as f:
            f.write("="*60 + "\n")
            f.write("TinyChirp Transformer-Time Training Results Summary\n")
            f.write("="*60 + "\n\n")
