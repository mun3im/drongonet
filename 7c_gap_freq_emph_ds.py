...
class TrainingConfig:
    ...
    output_dir: str = 'results_7c_gap_freq_emph_ds'
...
def build_cnn_gap_freq_emphasis_ds(input_shape=(184, 64, 1), num_classes=2):
    ...
    # Frequency Emphasis (same as V1.1)
...
def main():
    ...
    config.output_dir = f'results/7gap_freq_emph_ds_fft{config.n_fft}_m{config.n_mels}_s{config.random_seed}'
    ...
    try:
        ...
        model = build_cnn_gap_freq_emphasis_ds(input_shape=(184, config.n_mels, 1), num_classes=2)
