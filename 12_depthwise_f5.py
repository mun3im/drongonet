#!/usr/bin/env python3
"""
Model 12: Depthwise 5 filters (275K MACs)
...
def build_cnn_mel_model_table2(
    ...
    model = tf.keras.models.Model(inputs, outputs, name=f"MyBAD_12_depthwise_f5_m{input_shape[1]}")
...
def main():
    ...
    config.output_dir = f'results/12_depthwise_f5_m{config.n_mels}_s{config.random_seed}'
