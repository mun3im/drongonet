...
class TrainingConfig:
    ...
    output_dir: str = 'results/alt_tiny_gap_agg'
    cache_dir: str = '/Volumes/Evo/cache_seabad_tiny96'
...
def main():
    ...
    config.output_dir = f'results/alt_tiny_gap_agg_fft{config.n_fft}_m{config.n_mels}_s{config.random_seed}'
