...
TIER-1 Optimizations: Strided Conv (no MaxPool) + Tuned Focal Loss (α=0.75, γ=1.5)
"""
...
class TrainingConfig:
    ...
    def update_derived_paths(self):
        ...
        self.output_dir = f'results/3g_strided_focal_tuned_fft{self.n_fft}_m{self.n_mels}_s{self.random_seed}'
...
def build_model(input_shape=(184, 80, 1), num_classes=2):
    ...
    return tf.keras.Model(inputs, outputs, name="XiaoChirp_7e_strided_focal_tuned")
