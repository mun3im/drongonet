...
class TrainingConfig:
    ...
    output_dir: str = 'results/1b_mybad_cnntime'
    cache_dir: str = '/Volumes/Evo/cache_mybad_waveforms'
...
def main():
    ...
    config.output_dir = f'results/1b_mybad_cnntime_r{config.random_seed}_{platform.system().lower()}'
