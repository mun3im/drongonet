#!/usr/bin/env python3
"""
5b_depthwise_f5: Depthwise Separable 5 filters — Micro filter count sweep
...
def build_cnn_mel_model_table2(
    ...
    model = tf.keras.models.Model(inputs, outputs, name=f"SEABADNet_5b_depthwise_f5_m{input_shape[1]}")
...
def main():
    ...
    config.output_dir = f'results/5b_depthwise_f5_fft{config.n_fft}_m{config.n_mels}_s{config.random_seed}'
