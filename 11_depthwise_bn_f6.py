#!/usr/bin/env python3
"""
Model 11: Depthwise 6 filters + BatchNorm (330K MACs)
...
class TrainingConfig:
    ...
    n_mels: int = 48  # Using optimal n_mels from baseline sweep  # Number of mel bands
...
def build_cnn_mel_model_table2(
    ...
    model = tf.keras.models.Model(inputs, outputs, name=f"MyBAD_11_depthwise_bn_f6_m{input_shape[1]}")
...
def main():
    ...
    config.output_dir = f'results/11_depthwise_bn_f6_m{config.n_mels}_s{config.random_seed}'
