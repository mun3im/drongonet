...
class TrainingConfig:
    ...
    output_dir: str = 'results/2a_baseline_gap'
...
def build_cnn(
    ...
    No modifications except replacing FC layers with GAP.
    """
    ...
    model = tf.keras.models.Model(inputs, outputs, name=f"SEABAD_baseline_GAP_m{input_shape[1]}")
    return model
...
def main():
    ...
    config.output_dir = f'{RESULTS_BASE}/2a_baseline_gap_fft{config.n_fft}_m{config.n_mels}_s{config.random_seed}_{platform_tag}'
