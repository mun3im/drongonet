...
class TrainingConfig:
    ...
    output_dir: str = 'results_4d_dropout'
...
def build_cnn_mel_model_table2(
    ...
    model = tf.keras.models.Model(inputs, outputs, name=f"DrongoNet_4d_dropout04_m{input_shape[1]}")
...
def main():
    ...
    config.output_dir = f'{RESULTS_BASE}/4d_dropout04_fft{config.n_fft}_m{config.n_mels}_s{config.random_seed}_{platform_tag}'
