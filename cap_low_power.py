...
class TrainingConfig:
    ...
    output_dir: str = 'results/cap_low_power'
...
def build_cnn_mel_low_power(input_shape=(184, 16, 1), num_classes=2):
    ...
    return tf.keras.Model(inputs, outputs, name="SEABADNet_cap_low_power")
...
def main():
    ...
    config.output_dir = f'results/cap_low_power_fft{config.n_fft}_m{config.n_mels}_s{config.random_seed}'
