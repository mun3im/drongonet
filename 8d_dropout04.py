...
Ablation Study Model: 3d_dropout04
...
def build_cnn_mel_model_table2(
    ...
    Adds Dropout(0.4) before final classifier to reduce overfitting
    """
    ...
    model = tf.keras.models.Model(inputs, outputs, name=f"MyBAD_3d_dropout04_m{input_shape[1]}")
...
def main():
    ...
    config.output_dir = f'results/8d_dropout04_fft{config.n_fft}_m{config.n_mels}_s{config.random_seed}'
