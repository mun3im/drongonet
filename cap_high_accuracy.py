...
class TrainingConfig:
    ...
    output_dir: str = 'results/cap_high_accuracy'
...
def build_cnn_mel_high_acc(input_shape=(184, 64, 1), num_classes=2):
    ...
    return tf.keras.Model(inputs, outputs, name="SEABADNet_cap_high_accuracy")
...
def main():
    ...
    config.output_dir = f'results/cap_high_accuracy_fft{config.n_fft}_m{config.n_mels}_s{config.random_seed}'
