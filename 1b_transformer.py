...
class TrainingConfig:
    ...
    output_dir: str = 'results/1b_transformer'
    cache_dir: str = '/Volumes/Evo/cache_seabad_transformer_waveforms'

def parse_args():
    """Parse command line arguments"""
    parser = argparse.ArgumentParser(description='Train SEABAD Transformer-Time model')
...
def build_transformer_time_model(
    ...
    model = tf.keras.models.Model(inputs, outputs, name="SEABAD_TransformerTime")
...
def main():
    ...
    config.output_dir = f'results/1b_transformer_r{config.random_seed}_{platform.system().lower()}'
    ...
    logger.info("="*60)
    logger.info("SEABAD Transformer-Time Training")
    logger.info("="*60)
    ...
    try:
        ...
        with open(summary_path, 'w') as f:
            f.write("="*60 + "\n")
            f.write("SEABAD Transformer-Time Training Results Summary\n")
            f.write("="*60 + "\n\n")
