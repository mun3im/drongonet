...
Ablation Study Model: 2_depthwise
...
def main():
    ...
    config.output_dir = f'results/2_depthwise_fft{config.n_fft}_m{config.n_mels}_s{config.random_seed}_{platform.system().lower()}'
    ...
    logger.info("="*60)
    logger.info("MyBAD XiaoChirp-Depthwise Training")
    logger.info("="*60)
