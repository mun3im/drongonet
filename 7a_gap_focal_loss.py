...
class TrainingConfig:
    ...
    output_dir: str = 'results_7_low_power'
...
def build_cnn_mel_low_power(input_shape=(184, 16, 1), num_classes=2):
    ...
    return tf.keras.Model(inputs, outputs, name="MyBAD_GAP_Focal_loss")
...
def main():
    ...
    config.output_dir = f'results/7a_gap_focal_loss_fft{config.n_fft}_m{config.n_mels}_s{config.random_seed}'
    ...
    try:
        ...
        model = build_cnn_mel_low_power(input_shape=(184, config.n_mels, 1), num_classes=2)
